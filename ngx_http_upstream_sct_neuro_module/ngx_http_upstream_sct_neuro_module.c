    ...
    ngx_http_upstream_srv_conf_t *us)
{
    ...
    if (us->servers) {                                                  // сервера из upstream (если есть)
        ...
        // peers->nreq_since_last_weight_update = 0;
        // peers->gap_in_requests = 5; //TODO: переменную сделать
...
/*Говно начинается*/
    ...
    ngx_http_upstream_sct_neuro_peer_data_t  *scp = data;                              // записываем его в data
